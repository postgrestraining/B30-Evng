...
echo "$ASSUME_ROLE_POLICY" > /temp/assume-policy.json


# Create the role with the trust policy
aws iam create-role --role-name $IAM_DBUSER_ROLE --assume-role-policy-document  file:///temp/assume-policy.json  > /dev/null
